...
Window.clearcolor = (24/255, 96/255, 28/255, 1.0)
btn_color = (0.96, 0.79, 0.9, 1)
...
class PulseScr(Screen):
   def __init__(self, **kwargs):
       ...
       self.lbl_sec.bind(done=self.sec_finished) #действия
       ...
       self.line3 = BoxLayout(size_hint=(0.8, None), height='80sp', pos_hint={'center_x': 0.5}) #поменять
   ...
   def sec_finished(self, *args):
       ...
       self.in_result.set_disabled(False) #поля ввода сделали активным
       self.btn.set_disabled(False) #кнопку вклЮчили
       self.btn.text =  'Продолжить' #поменяли теекст кнопки

       self.line3.remove_widget(self.btn) #удалили старую кнопку
       self.line3.add_widget(self.btn)#с новЫм текстом показали
